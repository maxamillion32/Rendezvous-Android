...
public class AddOther extends ActionBarActivity implements View.OnClickListener
{
    TextView time,date;
    Button camera,done;
    ImageButton map;
    ImageView pic;
    EditText event_name,address,ticket,description,quota,video;
    TextView city;
    Spinner sCity;
    ...
    boolean isTimeSet = false, check1 = true, check2 = true;
    ...
    public void onClick(View v)
    {
        ...
        if(v == done) {
            ...
            if (s_event_name.equals("") || s_address.equals("") || s_quota == -1 || !isTimeSet || !isDateSet) {
            ...
            if( check1 && check2 && check3) {
                ...
                ParseObject other = new ParseObject("Events");

                other.put("name", s_event_name);
                other.put("organizerID", ParseUser.getCurrentUser().getObjectId());
                other.put("comments", new ArrayList<String>());
                other.put("date", year * 10000 + month * 100 + day);
                other.put("address", s_address);
                other.put("subscribers", new ArrayList<String>());
                other.put("key", (int) (Math.random() * 1000000));
                other.put("city", sCity.getSelectedItem());
                other.put("category", "Others");
                other.put("comments", new ArrayList<String>());
                other.put("isMapClicked", flag2);
                other.put("latitude", lat);
                other.put("longitude", lon);
                other.put("rating", 0 );
                other.put("numComment", 0);

                Bitmap btm;
                if (eventImage == null) {
                    btm = BitmapFactory.decodeResource(getResources(), R.drawable.plus);
                } else {
                ...
                other.put("eventImage", file);
                other.put( "rating", 0);
                other.put("time", hour * 100 + min);
                other.put("videoLink", s_video);
                other.put("ticketLink", s_ticket);
                other.put("description", s_description);
                other.put("quota", s_quota);
                other.put("organizerName", ParseUser.getCurrentUser().getString("username"));
                ...
                if( ParseUser.getCurrentUser().getParseFile("profilePhoto") != null ) {
                    ...
                    other.put("organizerPhoto", file2);
                }
                else {
                    Bitmap btm2;
    ...
    protected Dialog onCreateDialog(int id)
    {
        ...
        {
            return new TimePickerDialog(AddOther.this,TimePickerListener,hour,min,true);
        }

        else if(id == DIALOG_ID_DATE)
        {
            return new DatePickerDialog(AddOther.this,DatePickerListener,year,month,day);
        }
        return null;
    }
    ...
    private void selectImageOption()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddOther.this);
